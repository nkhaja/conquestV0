...
class ParseHelper {
    ...
    static func timelineRequestForCurrentUser(range: Range<Int>, completionBlock: PFQueryArrayResultBlock) {
        ...
        let postsFromFollowedUsers = Pin.query()
        postsFromFollowedUsers!.whereKey(ParsePostUser, matchesKey: ParseFollowToUser, inQuery: followingQuery)
        
        let postsFromThisUser = Pin.query()
...
//    
//    func listFriends() -> [PFUser]{
//        var users = []
//        let userQuery = PFQuery(className: "Follow")
//        userQuery.whereKey("fromUser", equalTo:PFUser.currentUser()!)
//        userQuery.whereKey("geoLocation", equalTo: PFGeoPoint(latitude: annotation.coordinate.latitude, longitude: annotation.coordinate.longitude))
//        
//        
